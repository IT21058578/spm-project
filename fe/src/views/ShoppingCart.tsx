        ...
        {shopping && shopping.length > 0 ?
          <div className="coupon-total row justify-content-between gap-2 text-dark">
            ...
            <div className="total p-4 border border-1 col-12 col-lg-3">
              ...
              <div className='my-3'><span className='fw-bold'>Taxes :</span><span className='float-end opacity-75'>RS 0.00</span></div>
              <hr />
              <div><span className='fw-bold'>Grand Total:</span><span className='float-end opacity-75'>{'RS' + total}</span></div>
