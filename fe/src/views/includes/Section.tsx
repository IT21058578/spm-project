          ...
          <div className="col-12 col-lg-3 py-3 py-lg-0 d-flex gap-2">
            ...
            <div>
              ...
              <span className="font-light opacity-75">
                Free shipping for your every perchase.
              </span>
            </div>
          </div>
          <div className="col-12 col-lg-3 py-3 py-lg-0 d-flex gap-2">
            ...
            <div>
              <h6 className="fw-bold">Get Quality Products</h6>
              <span className="font-light opacity-75">
                Find a range of best online clothing brands.
              </span>
            </div>
          </div>
          <div className="col-12 col-lg-3 py-3 py-lg-0 d-flex gap-2">
  ...
  return (
    ...
    >
      <div className="p-0 shadow">
        <img className="w-100 h-100" src={image1} alt="promotion 1" />
      </div>
      <div className="p-0 mt-3 mt-lg-0 shadow">
        <img className="w-100 h-100" src={image2} alt="promotion 1" />
      </div>
    </div>
  );
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Celebrate the sunny season with our exclusive Summer Sale. Enjoy a
          fantastic 39% discount on a wide range of products that will elevate
          your summer experience. Whether you're looking for stylish clothing,
          outdoor gear, or refreshing treats, our Summer Sale has you covered.
        </p>
        <Link
          to={RoutePaths.shop}
    ...
    <div className="promotion-3 position-relative shadow">
      <div className="position-relative promotion-2-image h-100">
        <span
          ...
          style={{ backgroundColor: "rgba(0,0,0,0.3)" }}
        ></span>
        <img src={banner2} alt="banner promo" className="w-100 h-100" />
      </div>
      <div
        className="promotion-text position-absolute w-100 p-2"
        style={{ top: "5%" }}
      >
        <h4>85% Cotton made</h4>
        <h3>Soft and comfortable</h3>
        <h4 className="fw-bold my-3">
          Started at <span className="fd-color-primary">RS 1200.00</span>
        </h4>
        <Link
          to={RoutePaths.shop}
...
const MakeCall = () => {
  return (
    <div
      className="make-call d-flex flex-wrap fw-bold justify-content-between fd-bg-secondary fd-color-primary w-100 py-4 px-2 px-lg-5 my-5"
    ...
    >
      ...
      <div className="align-self-center mt-3 mt-lg-0">
        <a
          href="#"
          className="bg-white fd-color-primary py-3 px-4"
